...
def load_from_standard_weights(input_file: str, device: str) -> dict[str, torch.Tensor]:
    ...
    if Path(input_file).suffix == ".safetensors":
    ...
    # VAE ENCODER MAPPINGS (Sequential layers 0, 1, 2, ...)
    # Layer 0: nn.Conv2d(3, 128, kernel_size=3, padding=1)
    ...
    # Layer 1: VAE_residualblock(128, 128)
    ...
    # Layer 2: VAE_residualblock(128, 128) 
    ...
    converted['encoder']['4.skip.weight'] = original_model['first_stage_model.encoder.down.1.block.0.nin_shortcut.weight']
    converted['encoder']['4.skip.bias'] = original_model['first_stage_model.encoder.down.1.block.0.nin_shortcut.bias']
    ...
    converted['encoder']['7.skip.weight'] = original_model['first_stage_model.encoder.down.2.block.0.nin_shortcut.weight']
    converted['encoder']['7.skip.bias'] = original_model['first_stage_model.encoder.down.2.block.0.nin_shortcut.bias']
    ...
    converted['decoder']['20.skip.weight'] = original_model['first_stage_model.decoder.up.0.block.0.nin_shortcut.weight']
    converted['decoder']['20.skip.bias'] = original_model['first_stage_model.decoder.up.0.block.0.nin_shortcut.bias']
    ...
    converted['decoder']['15.skip.weight'] = original_model['first_stage_model.decoder.up.1.block.0.nin_shortcut.weight']
    converted['decoder']['15.skip.bias'] = original_model['first_stage_model.decoder.up.1.block.0.nin_shortcut.bias']
